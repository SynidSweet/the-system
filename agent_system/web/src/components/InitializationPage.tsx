...
import { InitializationPageProps, InitializationSettings } from '../types';

function InitializationPage({ onInitialize }: InitializationPageProps) {
  const [settings, setSettings] = useState<InitializationSettings & { enableLogging: boolean }>({
    manualStepMode: true,
